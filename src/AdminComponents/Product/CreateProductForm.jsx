...
const CreateProductForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      const productData = {
        ...values,
        price: parseFloat(values.price), // Kiểm tra giá trị price có hợp lệ
        category: values.category || null, // Đảm bảo chỉ lấy id của category
        picture: values.picture || "", // Kiểm tra picture có hình ảnh nào không
      };
      dispatch(
        createProduct({
